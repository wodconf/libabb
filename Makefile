...
am_echo_client_OBJECTS = echo_client.$(OBJEXT)
echo_client_OBJECTS = $(am_echo_client_OBJECTS)
echo_client_DEPENDENCIES =
am_echo_server_OBJECTS = echo_server.$(OBJEXT)
...
CXXLINK = $(LIBTOOL) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(libabb_la_SOURCES) $(echo_client_SOURCES) \
	$(echo_server_SOURCES)
...
echo_client$(EXEEXT): $(echo_client_OBJECTS) $(echo_client_DEPENDENCIES) 
	@rm -f echo_client$(EXEEXT)
	$(CXXLINK) $(echo_client_OBJECTS) $(echo_client_LDADD) $(LIBS)
...
echo_client.o: examples/echo_client.cpp
	...
	mv -f $(DEPDIR)/echo_client.Tpo $(DEPDIR)/echo_client.Po
#	source='examples/echo_client.cpp' object='echo_client.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o echo_client.o `test -f 'examples/echo_client.cpp' || echo '$(srcdir)/'`examples/echo_client.cpp

echo_client.obj: examples/echo_client.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT echo_client.obj -MD -MP -MF $(DEPDIR)/echo_client.Tpo -c -o echo_client.obj `if test -f 'examples/echo_client.cpp'; then $(CYGPATH_W) 'examples/echo_client.cpp'; else $(CYGPATH_W) '$(srcdir)/examples/echo_client.cpp'; fi`
	mv -f $(DEPDIR)/echo_client.Tpo $(DEPDIR)/echo_client.Po
#	source='examples/echo_client.cpp' object='echo_client.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o echo_client.obj `if test -f 'examples/echo_client.cpp'; then $(CYGPATH_W) 'examples/echo_client.cpp'; else $(CYGPATH_W) '$(srcdir)/examples/echo_client.cpp'; fi`

echo_server.o: examples/echo_server.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT echo_server.o -MD -MP -MF $(DEPDIR)/echo_server.Tpo -c -o echo_server.o `test -f 'examples/echo_server.cpp' || echo '$(srcdir)/'`examples/echo_server.cpp
	mv -f $(DEPDIR)/echo_server.Tpo $(DEPDIR)/echo_server.Po
#	source='examples/echo_server.cpp' object='echo_server.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o echo_server.o `test -f 'examples/echo_server.cpp' || echo '$(srcdir)/'`examples/echo_server.cpp

echo_server.obj: examples/echo_server.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT echo_server.obj -MD -MP -MF $(DEPDIR)/echo_server.Tpo -c -o echo_server.obj `if test -f 'examples/echo_server.cpp'; then $(CYGPATH_W) 'examples/echo_server.cpp'; else $(CYGPATH_W) '$(srcdir)/examples/echo_server.cpp'; fi`
	mv -f $(DEPDIR)/echo_server.Tpo $(DEPDIR)/echo_server.Po
#	source='examples/echo_server.cpp' object='echo_server.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o echo_server.obj `if test -f 'examples/echo_server.cpp'; then $(CYGPATH_W) 'examples/echo_server.cpp'; else $(CYGPATH_W) '$(srcdir)/examples/echo_server.cpp'; fi`
